...
const AI_TOOL_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    type: "read",
    risk: "low",
    description: "Break down revenue generated by each employee.",
  },
  {
    id: "revenueByService",
    category: "Revenue",
    type: "read",
    risk: "low",
    description: "Break down revenue by individual service offerings.",
  },
  {
    id: "revenueByPaymentMethod",
    category: "Revenue",
    type: "read",
    risk: "low",
  ...
  {
    id: "searchBusinessData",
    category: "Search",
    type: "read",
    risk: "low",
    description:
      "Search customers, transactions, services, and expenses using natural language queries.",
  },
